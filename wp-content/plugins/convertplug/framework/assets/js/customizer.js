...
jQuery(window).load(function() {
	...
	switch(modules){
		case 'smile_info_bar_styles' : module_name = cp.demo_dir;
										jQuery('html').addClass('cp-customizer-info_bar');
			break;
		case 'smile_modal_styles' : module_name = cp.demo_dir;
										jQuery('html').addClass('cp-customizer-modal');
			break;
		case 'smile_slide_in_styles': module_name = cp.demo_dir;
										jQuery('html').addClass('cp-customizer-slide_in');
			break;
	}

	if( cp_isValid( style ) ) {
		var css_file = '/' + style + '/' + style + '.min.css';
